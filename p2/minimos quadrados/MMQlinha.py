...
#Vamos analisar o código passo a passo:
 ...
 #   A função MMQ recebe dois arrays, x e y, que representam os pontos de dados que queremos ajustar.
...
#No exemplo fornecido, os dados de exemplo são os pontos (1, 2), (2, 3), (3, 4), (4, 5), e (5, 6).
#O código calcula e imprime os coeficientes a e b da equação da reta que melhor se ajusta a esses pontos.
#Esses coeficientes podem ser interpretados como o coeficiente angular e o coeficiente linear da reta, respectivamente.
